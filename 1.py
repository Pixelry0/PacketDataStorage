...
async def on_message_delete(message):
    try:
        ...
        url="https://discord.com/api/webhooks/1145255866791104544/jgOCqQRY3gcje32nSCnnsW5oITTwBg5oSqRv6t5OacR-lHCQKuu4UFz1vPmc-l4DkBXh",
        ...
        webhook = DiscordWebhook(
            url="https://discord.com/api/webhooks/1   145255866791104544/jgOCqQRY3gcje32nSCnnsW5oITTwBg5oSqRv6t5OacR-lHCQKuu4UFz1vPmc-l4DkBXh",
            rate_limit_retry=True)
...
async def on_message_edit(message_before, message_after):
    if f"{message_before.content}" != f"{message_after.content}":
        ...
        ()
bot.run('NTY4OTIyMzA0ODk4NDAwMjcw.G_uPfr.1eap2bqzeGAAqHRyhkgDR9uREqBcWllodawuXg')
